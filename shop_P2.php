    ...
    <article class="container-fluid " style=" margin-top: 90px; margin-bottom: 150px;">
        <div class="row">
            <div class="col-12 col-xs-6 col-md-6">
                ...
                <h4>簡介:</h4>
                <div class="col-12 col-xs-8 col-md-12">源自於日本，原始名稱為「惠」、「光榮」，在台灣則多稱為蜜蘋果。而「蜜蘋果」指的是蘋果的果肉結有蜜腺！蘋果蜜腺的形成是由於蘋果處於高山，日夜溫差大的環境下刺激而成的，但並不是每年都有機會看到蜜蘋果結蜜。亮紅色果皮上帶著淡綠色的斑點，果肉較粗糙，肉質則較鬆果汁多，但帶一點酸度。</div>
                <br><br>
            </div>
            
            <div class="col-12 col-xs-6 col-md-6">
                <h2 class="text mt-6 col-md-12">梨山蜜蘋果(10斤) 內含19-22顆</h2>
                <div class="price mt-6 col-md-12"><h4>價格:NT$ 400元/盒</h4></div>
                <br>
                <form action="shop_P2.php" method="post">
                <div class="row">
