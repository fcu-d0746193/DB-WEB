    ...
    <article class="container-fluid " style=" margin-top: 90px; margin-bottom: 150px;">
        <div class="row">
            <div class="col-12 col-xs-6 col-md-6">
                ...
                <h4>簡介:</h4>
                <div class="col-12 col-xs-8 col-md-12">梨山蜜雪梨為台灣特殊品種，更因海拔較高、氣溫冷，日夜溫差大，甜度高達13度以上，細嫩鮮脆多汁，特殊的梨帶蜜桃香氣無可比擬。</div>
                <br><br>
            </div>
            <div class="col-12 col-xs-6 col-md-6">
                <h2 class="text mt-6 col-md-12">羊毛</h2>
                <div class="price mt-6 col-md-12"><h4>價格:NT$ 50元/盒</h4></div>
                <br>
                <form action="shop_P3.php" method="post">
                <div class="row">
